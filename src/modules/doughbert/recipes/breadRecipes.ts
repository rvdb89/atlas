...
export const painDeCampagne: Recipe = {
  ...
  knowledgeBiteId: "pain-de-campagne",
...
export const donkerVolkoren: Recipe = {
  ...
  knowledgeBiteId: "donker-volkoren",
  plannerRoute: "/planner",
};
