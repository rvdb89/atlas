...
const napolitaansePizza: Recipe = {
  ...
  knowledgeBiteId: "napolitaanse-pizza",
...
const newYorkStylePizza: Recipe = {
  ...
  knowledgeBiteId: "new-york-style-pizza",
  plannerRoute: "/planner",
};
...
const detroitStylePizza: Recipe = {
  ...
  knowledgeBiteId: "detroit-style-pizza",
  plannerRoute: "/planner",
};
...
const romanPizzaTeglia: Recipe = {
  ...
  knowledgeBiteId: "roman-pizza-teglia",
  plannerRoute: "/planner",
};
...
const sicilianPanPizza: Recipe = {
  ...
  knowledgeBiteId: "sicilian-pan-pizza",
  plannerRoute: "/planner",
};
