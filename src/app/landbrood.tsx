...
import { FLOUR_LABELS, getRecipe } from "@/data/recipes";
import type { FlourKey, RecipeIngredient } from "@/types/recipe";
...
const flourEntries = (Object.entries(recipe.flour) as [FlourKey, number][]).filter(
